...
part 'ds_role_visibility_config.freezed.dart';
...
class DSRoleVisibilityInputDecoration with _$DSRoleVisibilityInputDecoration {
  ...
  }) = _DSRoleVisibilityInputDecoration;
}