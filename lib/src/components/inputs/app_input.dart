...
class AppInput extends StatefulWidget {
  ...
  /// Si el input est� habilitado
  final bool enabled;

  /// Si el input es de solo lectura
  final bool readOnly;

  /// Si se debe ocultar el texto (para contrase�as)
  final bool obscureText;

  /// Car�cter de oscurecimiento
  ...
  /// N�mero m�nimo de l�neas (para multiline)
  final int? minLines;

  /// Si se debe mostrar el contador de caracteres
  final bool showCounter;

  /// Si se debe mostrar el bot�n de limpiar
