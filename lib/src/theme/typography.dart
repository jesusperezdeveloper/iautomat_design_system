...
class AppTypography {
  ...
  /// Obtiene la configuración base de Google Fonts para Inter
  ///
  ...
  /// Google Fonts gestiona automáticamente la descarga y cache de la fuente.
  static TextStyle _getBaseTextStyle({
  ...
  static TextStyle get h1 => _getBaseTextStyle(
        fontSize: 48,
  ...
  static TextStyle get h2 => _getBaseTextStyle(
        fontSize: 40,
        fontWeight: FontWeight.w700,
        height: 1.15,
        letterSpacing: -0.02,
  ...
  static TextStyle get h3 => _getBaseTextStyle(
        fontSize: 32,
  ...
  static TextStyle get h4 => _getBaseTextStyle(
        fontSize: 28,
        fontWeight: FontWeight.w600,
        height: 1.25,
        letterSpacing: -0.01,
  ...
  static TextStyle get h5 => _getBaseTextStyle(
        fontSize: 24,
        fontWeight: FontWeight.w600,
        height: 1.3,
        letterSpacing: 0,
  ...
  static TextStyle get h6 => _getBaseTextStyle(
        fontSize: 20,
        fontWeight: FontWeight.w600,
        height: 1.35,
        letterSpacing: 0,
  ...
  static TextStyle get bodyLarge => _getBaseTextStyle(
        fontSize: 18,
  ...
  static TextStyle get bodyMedium => _getBaseTextStyle(
        fontSize: 16,
        fontWeight: FontWeight.w400,
        height: 1.5,
        letterSpacing: 0,
  ...
  static TextStyle get bodySmall => _getBaseTextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w400,
        height: 1.45,
        letterSpacing: 0,
  ...
  static TextStyle get labelLarge => _getBaseTextStyle(
        fontSize: 16,
  ...
  static TextStyle get labelMedium => _getBaseTextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w500,
        height: 1.4,
        letterSpacing: 0.01,
  ...
  static TextStyle get labelSmall => _getBaseTextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        height: 1.35,
        letterSpacing: 0.02,
  ...
  /// Tama�o: 16px | Peso: 600 (SemiBold) | Line Height: 1.25
  /// Letter spacing optimizado para legibilidad en elementos peque�os
  static TextStyle get button => _getBaseTextStyle(
        fontSize: 16,
        fontWeight: FontWeight.w600,
        height: 1.25,
        letterSpacing: 0.02,
  ...
  /// Tama�o: 12px | Peso: 400 (Regular) | Line Height: 1.4
  static TextStyle get caption => _getBaseTextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w400,
        height: 1.4,
        letterSpacing: 0.01,
  ...
  /// Tama�o: 12px | Peso: 600 (SemiBold) | Line Height: 1.35
  /// Todo en may�sculas para mejor jerarqu�a visual
  static TextStyle get overline => _getBaseTextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w600,
        height: 1.35,
        letterSpacing: 0.08,
  ...
  static TextStyle withOpacity(TextStyle style, double opacity) {
    return style.copyWith(
      color:
          (style.color ?? const Color(0xFF000000)).withValues(alpha: opacity),
    );
  }
  ...
  static const List<String> fontFamilies = ['Inter'];

  /// Font family base como string para tests
  static const String baseFontFamily = 'Inter';
